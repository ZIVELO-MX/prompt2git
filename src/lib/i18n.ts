...
const dict: Record<string, { es: string; en: string }> = {
  ...
  'landing.nav.cta':               { es: 'Empieza ahora →',                             en: 'Start now →' },
  'landing.hero.badge':            { es: 'En producción · IA incluida · 20 comandos gratis', en: 'In production · AI included · 20 free commands' },
  ...
  'landing.hero.cta':              { es: 'Empieza ahora',                                 en: 'Start now' },
  ...
  'landing.features.multi_provider_d':     { es: 'En el plan Pro conectás tu propia API key (BYOK) del proveedor que prefieras: Anthropic, OpenAI, Gemini, Groq, Mistral u OpenRouter. Comandos ilimitados, tus costos.', en: 'On the Pro plan, bring your own API key (BYOK) from any provider: Anthropic, OpenAI, Gemini, Groq, Mistral or OpenRouter. Unlimited commands, your costs.' },
  'landing.features.sync_history':         { es: 'Historial sincronizado',                en: 'Synced history' },
  'landing.features.sync_history_d':       { es: 'Iniciá sesión con Magic Link o GitHub y tu historial de comandos se sincroniza entre todos tus dispositivos.', en: 'Sign in with Magic Link or GitHub and your command history syncs across all your devices.' },
  ...
  'landing.cta.title':                     { es: '¿Listo para olvidar<br /><strong>los flags de Git</strong>?', en: 'Ready to forget<br /><strong>Git flags</strong>?' },
  'landing.cta.sub':                       { es: 'Empezá gratis — la IA está incluida, no necesitás configurar nada. Sin espera, sin lista de espera.', en: 'Start free — AI is included, no setup needed. No waitlist.' },
  'landing.cta.btn':                       { es: 'Empieza ahora — es gratis',              en: 'Start now — it\'s free' },
  'landing.cta.note':                      { es: 'Sin registro complicado · Magic Link o GitHub · 20 comandos gratis al mes · IA incluida', en: 'No complicated signup · Magic Link or GitHub · 20 free commands per month · AI included' },
